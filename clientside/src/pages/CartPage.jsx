        ...
        <div className="container mt-3 ">
          <div className="row ">
            <div className="col-md-6  p-0 m-0">
              {cart?.map((p) => (
                <div className="row card flex-row text-center" key={p._id}>
                  <div className="col-md-6">
                    <img
                      src={`/api/v1/product/productphoto/${p._id}`}
                      className="card-img-top w-75 mt-2"
                      alt={p.name}
                     
                    />
                    <div className=" m-3 cart-remove-btn">
                    <button
                  ...
                  <div className="col-md-6 h-100 mt-2 p-5 ">
